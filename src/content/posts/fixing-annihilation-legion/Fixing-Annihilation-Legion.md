...
Skorpekh Destroyers plus a Lord are the most efficient MSU trade pieces Necron players have access to. 170 points buys you 12 s7 ap2 d2 attacks with lethal hits and once-per-game dev wounds that always reroll hits of 1 and fully reroll hits on the charge. On top of this you get the Lord's 4 s10 ap3 d3 strike or 8 s6 ap1 d1 sweep. If all that wasn't tasty enough, he also deals impact mortals on the charge. They also move 8 inches too, so you can yeet this package at pretty much anything and be confident that you're gonna break whatever they slam into.
